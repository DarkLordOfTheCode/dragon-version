...
def mall_tm_shop(player):
    print()
    print("=" * 40)
    print("  JUBILIFE MALL — FLOOR 2 TM SHOP")
    print("=" * 40)
    print()

    tms = [
        ("Iron Head",    "Steel",   2500),
        ("Flash Cannon", "Steel",   2500),
        ("Dragon Claw",  "Dragon",  2000),
        ("Dragon Pulse", "Dragon",  2000),
        ("Earthquake",   "Ground",  3000),
        ("Stone Edge",   "Rock",    3000),
    ]
...
def jubilife_city(player):
    ...
    while True:
        ...
        if not state["airship_done"]:
            print("  4. Northern Platform — Team Fairy Airship")
